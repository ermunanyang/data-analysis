...
const statusOptions = [
  { value: "", label: "全部" },
  { value: "200", label: "成功" },
  { value: "400", label: "客户端错误" },
  { value: "500", label: "服务端错误" },
];
...
export default function ApiLogsPage() {
  ...
  const columns: TableColumnsType<ApiLog> = [
    ...
    },
    {
      ...
      dataIndex: "apiModule",
      key: "apiModule",
      render: (module: string | null) => module || "-",
    },
    {
      title: "响应状态",
        ...
        {selectedLog && (
          <Descriptions bordered column={2}>
            ...
            <Descriptions.Item label="请求方法">
              <Tag color={getMethodColor(selectedLog.requestMethod)}>{selectedLog.requestMethod}</Tag>
            </Descriptions.Item>
            <Descriptions.Item label="响应状态">
              <Tag color={getStatusColor(selectedLog.responseStatus)}>{selectedLog.responseStatus || "-"}</Tag>
            </Descriptions.Item>
