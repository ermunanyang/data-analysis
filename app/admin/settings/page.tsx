    ...
    try {
      ...
      if (data.success) {
        form.setFieldsValue({
          ...
          autoBackupFrequency: data.data.autoBackupFrequency || "daily",
        });
      }
    } catch {
        ...
        >
          ...
          >
            <Space direction="vertical">
              <Input.Group compact>
                <Form.Item name="autoBackupFrequency" noStyle>
                  <Input style={{ width: 200 }} placeholder="daily/weekly/monthly" />
                </Form.Item>
              </Input.Group>
              <Text type="secondary">可选值：daily（每日）、weekly（每周）、monthly（每月）</Text>
            </Space>
          </Form.Item>
